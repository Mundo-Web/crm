import{C as d,c as m,j as e,r as i,G as r,m as c}from"./CreateReactScript-CmWo5qkO.js";import{A as p,i as u}from"./Adminto-CKJqMW0R.js";import{S as t}from"./sweetalert2.esm.all-CCQp_QLN.js";import"./Logout-BADx6B1u.js";const h=({apikey:a})=>{const s=i.useRef();i.useEffect(()=>{},[null]);const o=()=>{c.Clipboard.copy(s.current.value,()=>{t.fire({title:"Correcto!",text:"Se ha copiado el API Key en el portapapeles",timer:2e3})},x=>{t.fire({title:"Ooops!",text:error,timer:2e3})})},n=`<!-- Script para enviar formularios con captura automática de UTMs a Atalaya CRM -->
<script>
(function () {
...
}`})})]}),e.jsx("div",{className:"tab-pane fade",id:"utm-guide",role:"tabpanel","aria-labelledby":"guide-tab",children:e.jsx("div",{className:"table-responsive",children:e.jsxs("table",{className:"table table-bordered table-sm font-13 align-middle mb-0",children:[e.jsx("thead",{className:"table-light",children:e.jsxs("tr",{children:[e.jsx("th",{children:"Parámetro UTM"}),e.jsx("th",{children:"Valores Recomendados"}),e.jsx("th",{children:"Cómo lo procesa Atalaya CRM"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_source"})}),e.jsxs("td",{children:[e.jsx("code",{children:"meta"}),", ",e.jsx("code",{children:"facebook"}),", ",e.jsx("code",{children:"instagram"}),", ",e.jsx("code",{children:"messenger"}),", ",e.jsx("code",{children:"whatsapp"})]}),e.jsxs("td",{children:["Asigna Origen: ",e.jsx("span",{className:"badge bg-primary",children:"Meta"})]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_source"})}),e.jsxs("td",{children:[e.jsx("code",{children:"google"}),", ",e.jsx("code",{children:"googleads"})]}),e.jsxs("td",{children:["Asigna Origen: ",e.jsx("span",{className:"badge bg-danger",children:"Google"})]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_source"})}),e.jsx("td",{children:e.jsx("code",{children:"tiktok"})}),e.jsxs("td",{children:["Asigna Origen: ",e.jsx("span",{className:"badge bg-dark",children:"TikTok"})]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_source"})}),e.jsx("td",{children:e.jsx("code",{children:"linkedin"})}),e.jsxs("td",{children:["Asigna Origen: ",e.jsx("span",{className:"badge bg-info",children:"LinkedIn"})]})]}),e.jsxs("tr",{children:[e.jsxs("td",{children:[e.jsx("code",{children:"utm_source"})," (vacío o sin UTM)"]}),e.jsx("td",{children:e.jsx("em",{children:"(No enviado)"})}),e.jsxs("td",{children:["Asigna Origen: ",e.jsx("span",{className:"badge bg-secondary",children:"Orgánico"})]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_medium"})}),e.jsxs("td",{children:[e.jsx("code",{children:"cpc"}),", ",e.jsx("code",{children:"paid"}),", ",e.jsx("code",{children:"ads"})]}),e.jsxs("td",{children:["Clasificado como Proceso/Tipo: ",e.jsx("b",{children:"Anuncio"})]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_campaign"})}),e.jsx("td",{children:"Nombre de tu campaña"}),e.jsxs("td",{children:["Vincula / Crea la ",e.jsx("b",{children:"Campaña"})," automáticamente en Atalaya"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_term"})}),e.jsx("td",{children:"Grupo de anuncios o palabra clave"}),e.jsxs("td",{children:["Guarda el ",e.jsx("b",{children:"Grupo de Anuncios"})," (AdSet)"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"utm_content"})}),e.jsx("td",{children:"Nombre o ID del anuncio"}),e.jsxs("td",{children:["Guarda el ",e.jsx("b",{children:"Anuncio"})," (Creativo)"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"triggered_by"})}),e.jsxs("td",{children:[e.jsx("code",{children:"Formulario Landing"})," o nombre libre"]}),e.jsx("td",{children:"Registra el disparador de entrada del lead"})]})]})]})})}),e.jsxs("div",{className:"tab-pane fade",id:"landing-script",role:"tabpanel","aria-labelledby":"script-tab",children:[e.jsxs("div",{className:"d-flex justify-content-between align-items-center mb-2",children:[e.jsx("span",{className:"text-muted font-13",children:"Copia y pega este script en tu landing page para capturar UTMs automáticamente:"}),e.jsxs("button",{className:"btn btn-sm btn-dark",type:"button",onClick:l,children:[e.jsx("i",{className:"fa fa-clipboard me-1"})," Copiar Script"]})]}),e.jsx("pre",{style:{maxHeight:"350px",overflowY:"auto"},children:e.jsx("code",{children:n})})]}),e.jsxs("div",{className:"tab-pane fade",id:"curl-example",role:"tabpanel","aria-labelledby":"curl-tab",children:[e.jsx("h5",{children:"Ejemplo con cURL:"}),e.jsx("pre",{children:e.jsx("code",{children:`curl -X POST "https://${r.APP_CORRELATIVE}.${r.APP_DOMAIN}/free/leads" \\
...
}`})})})]})]})]})]})})]})})};d((a,s)=>{if(!s.can("integrations","forms","all"))return location.href="/";m(a).render(e.jsx(p,{...s,title:"API Keys",children:e.jsx(h,{...s})}))});
