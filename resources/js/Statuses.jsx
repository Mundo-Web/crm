                ...
                <div className="row align-items-start justify-content-center">
                    ...
                    table.id == '9c27e649-574a-47eb-82af-851c5d425434'
                      ? */}
                                ...
                                <div
                                    className="card-body d-flex align-items-start justify-content-center gap-2"
                                    style={{
                                        flexWrap: "wrap",
                                        minHeight: "200px",
                                        maxHeight: "300px",
            ...
            >
                <div className="row" id="status-crud-container">
                    ...
                    <div className="col-12 mb-2">
                        <CheckboxFormGroup
                            eRef={requireRef}
                            label="¿Requerir producto?"
                            id="require"
                            title="Obliga al usuario a escoger un producto antes de cambiar a este estado"
                            checked={require}
                    ...
                    <div className="col-12 mb-2" hidden={!showPipeline}>
                        <CheckboxFormGroup
                            eRef={requireRef}
                            label="¿Mostrar en Pipeline?"
                            id="pipeline"
                            title="Si está activo, este estado aparecerá en el pipeline de leads; si no, permanecerá oculto"
                            checked={pipeline}
                            setChecked={setPipeline}
                        />
                    </div>
...
CreateReactScript((el, properties) => {
    if (!properties.can("statuses", "root", "all", "list"))
