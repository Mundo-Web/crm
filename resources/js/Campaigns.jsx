...
const AdsList = ({ adSetId, campaignId }) => {
    ...
    if (loading)
        return (
            <div className="p-3 text-muted small d-flex align-items-center">
        ...
        >
            ...
            <div className="d-flex flex-column gap-3 mt-2">
                {ads.map((ad) => (
                    ...
                    >
                        <div
                            className="d-flex justify-content-between align-items-start p-3 hover-bg-light"
                            style={{
                                cursor: "pointer",
                        ...
                        >
                            <div className="d-flex gap-3 align-items-start">
                                <div className="flex-shrink-0">
                                    {ad.preview_image_url ? (
                                        <div
                                            className="rounded border bg-light d-flex align-items-center justify-content-center shadow-sm"
                                            style={{
                                                width: "48px",
                                                height: "48px",
                                                overflow: "hidden",
                                        ...
                                        <div
                                            className="bg-soft-primary text-primary rounded d-flex align-items-center justify-content-center shadow-sm"
                                            style={{
                                                width: "48px",
                                                height: "48px",
                                            }}
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="d-flex align-items-center gap-2 mt-2 flex-wrap">
                                        {Number(ad.spend) > 0 && (
                                            <span
                                                className="badge bg-soft-success text-success border border-success border-opacity-25"
                                                style={{ fontSize: "11px" }}
                                            >
                            ...
                            <div className="d-flex flex-column align-items-end gap-2">
                                <span
                                    className={`badge ${ad.status === "ACTIVE" ? "bg-success" : "bg-secondary"} rounded-pill shadow-sm`}
                                    style={{ fontSize: "10px" }}
                                >
                                    {ad.status || "INACTIVE"}
                                </span>
                                ...
                                >
                                    <i
                                        className={`mdi ${expandedAd === ad.id ? "mdi-chevron-up" : "mdi-chevron-down"} text-muted`}
                                    ></i>
                                </div>
                            </div>
                        </div>
        ...
        <div className="mt-2 ps-3">
            ...
            <div className="d-flex flex-column gap-2 mt-3">
                {adSets.map((as) => (
                    ...
                    >
                        <div
                            className="d-flex justify-content-between align-items-center p-3 rounded bg-white border hover-shadow-sm"
                            style={{
                                cursor: "pointer",
                                transition: "all 0.2s",
                                boxShadow:
                            ...
                            onClick={() =>
                                setExpandedId(
                                    expandedId === as.id ? null : as.id,
                                )
                            }
                        >
                            <div className="d-flex align-items-center gap-3">
                                <div
                                    className={`rounded-circle d-flex align-items-center justify-content-center transition-all ${expandedId === as.id ? "bg-warning text-white shadow-sm" : "bg-soft-warning text-warning"}`}
                                    style={{ width: "36px", height: "36px" }}
                                >
                                    <i
                                        className={`mdi ${expandedId === as.id ? "mdi-layers" : "mdi-layers-outline"} h5 mb-0`}
                                    ></i>
                                </div>
                                <div className="d-flex flex-column">
                                    <span
                            ...
                            <div className="d-flex align-items-center gap-3">
                                <span
                                    className={`badge ${as.status === "ACTIVE" ? "bg-success text-white" : "bg-secondary text-white"} rounded-pill shadow-sm`}
                                    style={{
                                        fontSize: "11px",
                                        padding: "0.4em 0.8em",
                                    }}
                                ...
                                <div
                                    className="bg-soft-light rounded-circle d-flex align-items-center justify-content-center"
                                    style={{ width: "32px", height: "32px" }}
                                >
                                    <i
                                        className={`mdi ${expandedId === as.id ? "mdi-chevron-up" : "mdi-chevron-down"} text-muted h5 mb-0`}
                                    ></i>
                                </div>
                            </div>
                        </div>
...
const CampaignItem = ({ campaign, onEdit, onDelete, onSync }) => {
    ...
    const cpl =
        Number(campaign.spend) > 0 && Number(campaign.clients_count) > 0
            ? (Number(campaign.spend) / Number(campaign.clients_count)).toFixed(
                  2,
              )
            : "0.00";
    ...
    return (
        ...
        >
            <div className="card-body p-0">
                <div
                    className={`d-flex align-items-center p-4 ${isExpanded ? "bg-soft-light" : "bg-white"}`}
                    style={{ cursor: "pointer" }}
                    onClick={() => setIsExpanded(!isExpanded)}
                >
                    <div className="me-4 flex-shrink-0">
                        <div
                            className={`rounded-circle d-flex align-items-center justify-content-center shadow-sm ${isExpanded ? "bg-primary text-white" : "bg-soft-primary text-primary"}`}
                            style={{
                                width: "56px",
                                height: "56px",
                                transition: "all 0.3s",
                        ...
                        >
                            <i
                                className={`mdi ${isExpanded ? "mdi-folder-open" : "mdi-folder"} h3 mb-0`}
                            ></i>
                        </div>
                    </div>
                    <div className="flex-grow-1">
                        <div className="d-flex align-items-center gap-2 mb-2">
                            <span
                                className="badge bg-light text-secondary border font-monospace shadow-sm"
                                style={{
                                    fontSize: "11px",
                                    padding: "0.4em 0.8em",
                                }}
                        ...
                        <div className="d-flex align-items-center gap-3 mt-2 flex-wrap bg-light p-2 rounded-3 border">
                            <div className="d-flex align-items-center gap-2 px-3 py-1 border-end">
                                <div
                                    className="bg-soft-success text-success rounded-circle d-flex align-items-center justify-content-center"
                                    style={{ width: "28px", height: "28px" }}
                                >
                            ...
                            <div className="d-flex align-items-center gap-2 px-3 py-1 border-end">
                                <div
                                    className={`rounded-circle d-flex align-items-center justify-content-center ${Number(campaign.clients_count) > 0 ? "bg-soft-primary text-primary" : "bg-soft-secondary text-secondary"}`}
                                    style={{ width: "28px", height: "28px" }}
                                >
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <span
                                        className={`${Number(campaign.clients_count) > 0 ? "text-primary" : "text-dark"} fw-bold`}
                                        style={{ fontSize: "13px" }}
                                    >
                                        {campaign.clients_count || 0}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center gap-2 px-3 py-1 border-end">
                                <div
                                    className={`rounded-circle d-flex align-items-center justify-content-center ${Number(cpl) > 0 ? "bg-soft-danger text-danger" : "bg-soft-secondary text-secondary"}`}
                                    style={{ width: "28px", height: "28px" }}
                                >
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <span
                                        className={`${Number(cpl) > 0 ? "text-danger" : "text-dark"} fw-bold`}
                                        style={{ fontSize: "13px" }}
                                    >
                                        ${cpl}
                                    </span>
                            ...
                            <div className="d-flex align-items-center gap-2 px-3 py-1">
                                <div className="d-flex flex-column text-end">
                                    ...
                                    <span
                                        ...
                                        style={{ fontSize: "11px" }}
                                    >
                                        <i className="mdi mdi-cursor-default-click me-1"></i>{" "}
                                        {Number(
                                            campaign.clicks,
                                        ).toLocaleString()}{" "}
                                        Clics
                    ...
                    <div
                        className="d-flex align-items-center gap-3 ms-3"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="form-check form-switch">
                            <input
                                className="form-check-input form-check-success cursor-pointer"
                        ...
                        <div className="btn-group shadow-sm rounded-pill bg-white border">
                            <button
                                className="btn btn-sm btn-white text-primary border-end"
                        ...
                        >
                            <i
                                className={`mdi ${isExpanded ? "mdi-chevron-up" : "mdi-chevron-down"} h5 mb-0 text-secondary`}
                            ></i>
                        </div>
                    </div>
                </div>
...
const Campaigns = ({ can, hasFormsIntegration }) => {
    ...
    return (
        <div className="container-fluid py-4">
            <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div>
                    ...
                    <p className="text-muted mb-0">
                        Organiza y sincroniza tus anuncios de Meta en tiempo
                        real.
                    </p>
                </div>
                <div className="d-flex gap-2">
                    {can("campaigns", "all", "sync") && hasFormsIntegration && (
                        <button
                            className="btn btn-info rounded-pill px-3 shadow-sm d-flex align-items-center gap-2"
                    ...
                    {can("campaigns", "all", "create") && (
                        <button
                            hidden
                            className="btn btn-primary rounded-pill px-3 shadow-sm d-flex align-items-center gap-2"
                            onClick={() => onModalOpen()}
                        >
                ...
                <div className="campaign-list">
                    {filteredCampaigns.length === 0 ? (
                        ...
                        >
                            ...
                            <h4 className="mt-3 text-dark fw-bold">
                                No se encontraron campañas
                            </h4>
                            <p className="text-muted">
                                Prueba con otros términos de búsqueda o agrega
                                una nueva.
                            </p>
                        </div>
                    ) : (
            ...
            <Modal
                modalRef={modalRef}
                title={isEditing ? "Editar campaña" : "Agregar campaña"}
...
CreateReactScript((el, properties) => {
    if (!properties.can("campaigns", "root", "all", "list"))
