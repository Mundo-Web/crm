...
const Adminto = ({ session, children, notificationsCount, title, can, WA_URL, APP_URL, presets, businesses, APP_PROTOCOL,  APP_DOMAIN, leadsCount }) => {
  ...
  return (<>
    <div id="wrapper">
      ...
      <Menu session={session} can={can} presets={presets} APP_DOMAIN={APP_DOMAIN} businesses={businesses} APP_PROTOCOL={APP_PROTOCOL} leadsCount={leadsCount} />
