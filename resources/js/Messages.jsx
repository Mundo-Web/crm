      ...
      <div class="col-xl-3 col-lg-4">
          ...
          <div class="card-body">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img src="assets/images/users/user-1.jpg" alt=""
                  class="flex-shrink-0 rounded-circle avatar-sm"/>
              </div>
            ...
            <hr class="my-3"/>
              ...
              <hr class="my-3"/>
                ...
                <div class="">
                  <ul class="list-unstyled chat-list mb-0" style={{maxHeight: '413px'}}
                    data-simplebar>
                    <li class="active">
                      <a href="#">
                        <div class="d-flex">
                    ...
                    <li class="unread">
                      <a href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 overflow-hidden">
                            <h5 class="text-truncate font-14 mt-0 mb-1">Garret Sauer
                            </h5>
                    ...
                    <li>
                      <a href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 overflow-hidden">
                            <h5 class="text-truncate font-14 mt-0 mb-1">Michael James
                            </h5>
                    ...
                    <li class="unread">
                      <a href="#">
                        <div class="d-flex">
                          <div
                            class="flex-shrink-0 chat-user-img avatar-sm align-self-center me-2">
                            <span
                          ...
                          <div class="flex-grow-1 overflow-hidden">
                            <h5 class="text-truncate font-14 mt-0 mb-1">Felicia Johnson
                            </h5>
                    ...
                    <li>
                      <a href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 overflow-hidden">
                            <h5 class="text-truncate font-14 mt-0 mb-1">Richard Lopez
                            </h5>
                            <p class="text-truncate mb-0">Nice to meet you</p>
                          </div>
        ...
        <div class="col-xl-9 col-lg-8">
          <div class="conversation-list-card card">
            <div class="card-body">
              <div class="dropdown float-end">
                <a href="#" class="dropdown-toggle arrow-none card-drop font-20"
                  data-bs-toggle="dropdown" aria-expanded="false">
                  <i class="mdi mdi-dots-vertical"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  ...
                  <p class="font-13 text-muted mb-0"><i
                    class="mdi mdi-circle text-success me-1 font-11"></i> Active</p>
                </div>
              </div>
              <hr class="my-3"/>

                <div>
                  <ul class="conversation-list slimscroll" style={{maxHeight: '410px'}}
                    data-simplebar>
                    <li>
