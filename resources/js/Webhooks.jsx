...
const IntegrationWizardModal = ({ service, apikey, auth_token, onClose, onSuccess }) => {
  ...
  return <Modal modalRef={modalRef} title={`Integrar ${service?.toTitleCase()}`} size='lg' bodyClass='px-3 pt-0 pb-3' hideFooter>
    <form>
