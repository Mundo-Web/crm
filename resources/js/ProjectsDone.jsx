...
import ProjectsDoneRest from './actions/ProjectsDoneRest.js'

const subdomainsRest = new SubdomainsRest()
const projectsDoneRest = new ProjectsDoneRest()

const ProjectsDone = ({ statuses, can }) => {
  ...
  return (<>
    <Table gridRef={gridRef} title='Proyectos Terminados' rest={projectsDoneRest} exportable
      toolBar={(container) => {
...
CreateReactScript((el, properties) => {
  ...
  createRoot(el).render(
    <Adminto {...properties} title='Proyectos Terminados'>
      <ProjectsDone {...properties} />
    </Adminto>
  );
})