...
const LeadKanban = ({ statuses, leads, onLeadClicked, onOpenModal, onMakeLeadClient, onArchiveClicked, onDeleteClicked, onAttendClient }) => {

  const { defaultView, refreshLeads, getMoreLeads, leadsCount, statusesLoading } = useContext(LeadsContext)
  ...
  return <div className="d-flex gap-1 mb-3" style={{ overflowX: 'auto', minHeight: 'calc(100vh - 236px)' }}>
    {
