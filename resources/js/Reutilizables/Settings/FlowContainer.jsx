                ...
                <div className="d-flex justify-content-center align-items-start" style={{ minHeight: 'calc(100vh - 220px)' }}>
                    <div className="d-flex flex-column align-items-center">
                        ...
                        <div className="rounded bg-primary bg-opacity-10 text-primary px-2 py-1 fw-semibold">
                            ...
                            <small className='d-block border-bottom fw-normal cursor-pointer text-center mx-auto' style={{width: 'max-content'}} onClick={(e) => onModalOpen(e, 'gemini-first-message', 'Mensaje inicial', 'text', 'Hola soy boti, me permites tus datos personales')}>
