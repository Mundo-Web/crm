...
<head>
    <meta charset="utf-8">
    <title>Conectando con TikTok...</title>
</head>
<body style="background-color: #121212; color: #ffffff; display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    <div style="background-color: #1e1e1e; border: 1px solid #333333; padding: 2.5rem; border-radius: 16px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.5), 0 10px 10px -5px rgba(0, 0, 0, 0.4); text-align: center; max-width: 400px; width: 100%;">
        <!-- Success Check Icon with TikTok Colors -->
        <div style="width: 80px; height: 80px; background-color: #111111; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; position: relative;">
            <!-- TikTok Magenta & Cyan double shadow ring -->
            <div style="position: absolute; inset: 0; border-radius: 50%; border: 3px solid #ff0050; opacity: 0.8; filter: drop-shadow(0 0 4px #ff0050);"></div>
            <div style="position: absolute; inset: 2px; border-radius: 50%; border: 3px solid #00f2fe; opacity: 0.8; filter: drop-shadow(0 0 4px #00f2fe);"></div>
        ...
        <h2 style="color: #ffffff; font-size: 1.6rem; font-weight: 700; margin: 0 0 0.5rem; background: linear-gradient(45deg, #00f2fe, #ff0050); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">¡Conexión Exitosa!</h2>
        <p style="color: #aaaaaa; font-size: 0.95rem; line-height: 1.5; margin: 0 0 1.8rem;">Autenticación con TikTok completada. Transfiriendo credenciales a Atalaya CRM...</p>
        ...
        <div style="position: relative; width: 32px; height: 32px; margin: 0 auto;">
            ...
            <div style="position: absolute; width: 100%; height: 100%; border: 4px solid transparent; border-top-color: #00f2fe; border-bottom-color: #ff0050; border-radius: 50%; animation: spin 0.8s linear infinite;"></div>
        </div>
    </div>
